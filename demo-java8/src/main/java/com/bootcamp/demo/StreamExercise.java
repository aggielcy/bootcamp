...
public class StreamExercise {
  public static void main(String[] args) {
    ...
    Optional <Integer> MaxNumber = numbers2.stream().max((n1,n2) ->n1.compareTo(n2));
    MaxNumber.ifPresent(value -> System.out.println("Max: " + value)); //Max: 30

    Optional <Integer> MinNumber = numbers2.stream().min((n1,n2) ->n1.compareTo(n2));
    ...
    // Output: [15, 20]
    List<Integer> Newnumbers3 = numbers3.stream()
                                .filter(w -> w>10)
                                .collect(Collectors.toList());
    ...
    // where the key is the student's name and the value is their score.
     ...
     List <Student> studentsNameNValue = new ArrayList<>();

    // Create Student Class
    // new Student("Alice", 85)
    // new Student("Bob", 75)  

    System.out.println(studentsNameNValue);
    ...
    List <Integer> allNumbers2 = listOfIntegers.stream()
                                      .flatMap(e -> e.stream())
    ...
    List<Integer> newElements = elements.stream()
            .sorted((d1,d2) -> d1> d2? -1:1)
            .skip(3L)    //skip need to put Long value, can add or skip L
            .limit(5L)   //limit need to put Long value, can add or skip L
            .collect(Collectors.toList());
    ...
    List<Integer> newAmounts = amounts.stream()
            .map(a -> a*2)
    ...
    int concatStringLength = keywords.stream()
            ...
            .length();
   System.out.println(concatStringLength);
