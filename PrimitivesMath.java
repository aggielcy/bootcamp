public class PrimitivesMath {
  public static void main (String[]args){
   int count = 3;
    ...
    System.out.println(average2); // 93.0 becoz double show decimal value
    ...
    // Overflow
    byte b1 = -128;
    // Step 1: byte value - int value -> int value , so it can display
    System.out.println(b1 - 1); // -129

    // b1 = b1 - 3; this will be error 
    // becoz left hand is byte value (upper define byte variable) & right side is integer
    // System.out.println(b1);

    // byte value - int value -> int value
    // I take my own risk
    b1 = (byte) (b1 - 3); // assign -131 into b1
    System.out.println(b1); // 125 (overflow) <--using computer logic
    ...
    long newAmount = amount + 100_000_000L; //reassign
    System.out.println(newAmount); // 2200000000 use long so to appear the result
